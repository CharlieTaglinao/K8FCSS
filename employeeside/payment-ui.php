    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css"> <!-- Bootstrap for validation -->
            ...
            <section class="paymentui">
                <div class="container">
                    ...
                    <form id="payment-form" action="payment-ui.php" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="amount" class="form-label">Enter Amount (in pesos): <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="description" name="description" class="form-control" value="Chattel Mortgage Fees & Comprehensive Car Insurance" required>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="mb-3">
                            <label for="remarks" class="form-label">Enter Remarks: <span class="text-danger">*</span></label>
                            <textarea id="remarks" name="remarks" class="form-control" placeholder="Input specific amount of Chattel Mortgage Fees & Comprehensive Car Insurance" required></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <?php if (in_array($status_type, ['brand-new', 'second-hand', 'sangla-orcr'])): ?>
                            ...
                            <div class="mb-3">
                                <label for="amount-finance" class="form-label">Enter Amount Finance: <span class="text-danger">*</span></label>
                                <input type="text" id="amount-finance" name="amount_finance" class="form-control" placeholder="e.g., 500000" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="check-release" class="form-label">Enter Check Release: <span class="text-danger">*</span></label>
                ...
                <div class="container">
                    ...
                    <form id="payment-form" action="payment-ui.php" method="post" class="needs-validation" novalidate>
                        <div class="payment-ui-container">
                            ...
                            <div class="mb-3">
                                <label for="amount" class="form-label">Enter Amount: <span class="text-danger">*</span></label> <br>
                                <input type="text" id="amount" name="amount" class="form-control" placeholder="e.g., 1000" required>
                                <div class="invalid-feedback"></div>
                            </div>

                            <div class="mb-3">
                                <label for="description" class="form-label">Enter Description: <span class="text-danger">*</span></label> <br>
                                <input type="text" id="description" name="description" class="form-control" value="Chattel Mortgage Fees & Comprehensive Car Insurance" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            ...
                            <?php if (in_array($form_type, ['brand-new', 'second-hand', 'sangla-orcr'])): ?>
                                <div class="mb-3">
                                    <label for="term" class="form-label">Select Term: <span class="text-danger">*</span></label> <br>
                                    <select id="term" name="term" class="form-select" required>
                                ...
                                <div class="mb-3">
                                    <label for="amount-finance" class="form-label">Enter Amount Finance: <span class="text-danger">*</span></label> <br>
                                    <input type="text" id="amount-finance" name="amount_finance" class="form-control" placeholder="e.g., 500000" required>
                                    <div class="invalid-feedback"></div>
                                </div>

                                <div class="mb-3">
                                    <label for="maturity" class="form-label">Enter Maturity: <span class="text-danger">*</span></label> <br>
                                    <input type="date" id="maturity" name="maturity" class="form-control" required>
                                    <div class="invalid-feedback"></div>
                                </div>

                                <div class="mb-3">
                                    <label for="check-release" class="form-label">Enter Check Release: <span class="text-danger">*</span></label> <br>
                                    <input type="date" id="check-release" name="check_release" class="form-control" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="remarks-container">
                            <label for="remarks" class="form-label">Enter Remarks: <span class="text-danger">*</span></label> <br>
                            <textarea id="remarks" name="remarks" class="form-control" placeholder="Enter your remarks..." maxlength="300" required></textarea>
