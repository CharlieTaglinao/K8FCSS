...
function sendCongratulationsEmail($email, $clientname, $form_type, $transaction_id){
    $formatted_form_type = formatFormType($form_type);
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                <p>Congratulations, your" . strtolower($formatted_form_type) . " application has been approved.</p>
                <p><strong>Transaction ID: </strong> $transaction_id</p>
                <p>Thank you for choosing K8 Financial Consulting Services. We are excited to continue serving you and assisting with your needs.</p>
            </div>
            <div class='footer'>
                <p>&copy; " . date('Y') . " K8 Financial Consulting Services. All rights reserved.</p>
            </div>
