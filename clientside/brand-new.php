...
<head>
    ...
    <title>Application Form | Brand New</title>
...
<body>
    ...
    <div class="popup-overlay"></div> <!-- Add this line -->
    <?php include '../required/navbarOnLogin.php'; ?>
    <div class="main-content">
        <div class="form-container">
            <h1>Application Form | Brand New</h1>
            <div class="form-note">
            ...
            <form id="application-form" action="process/process_brand_new_form.php" method="post" class="needs-validation">
                <input type="hidden" name="value-of-formtype" value="brand-new">
                <!-- Page 1 -->
                    ...
                    <div class="form-inputs">
                        ...
                        <div class="form-group">
                            <label for="appointment-time">Appointment Time: <span
                                    class="required-asterisk">*</span></label>
                            <select id="appointment-time" name="appointment_time" class="form-select">
                    ...
                    <div class="form-inputs">
                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="transmition-type" name="transmition_type" class="form-select" >
                                        <option value="">--Select--</option>
                    ...
                    <div class="form-inputs">
                        <div class="form-group">
                            ...
                            <div class="income-source-select">
                                <select id="income-source" name="income_source" class="form-select" >
    ...
    <script src="assets/js/brand-new.js"></script> <!-- Link to your JavaScript file -->
